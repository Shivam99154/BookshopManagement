...
class bookshope
{
	...
	void bookshope::show_books()
	{
		...
		{
			cout<<"\n"<<setw(10)<<"Book ID"<<setw(20)<<"Book Name"<<setw(20)<<"Author"<<setw(20)<<"No. of Copy"<<"\n\n";
			file>>b_id>>b_name>>a_name>>no_copy;
			while(!file.eof())
			{
				cout<<setw(10)<<b_id<<setw(20)<<b_name<<setw(20)<<a_name<<setw(20)<<no_copy<<"\n\n";
				file>>b_id>>b_name>>a_name>>no_copy;
			}
			file.close();
		}
